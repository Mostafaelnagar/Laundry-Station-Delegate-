...
import app.laundrydelegate.databinding.NotificationItemBinding;
import app.laundrydelegate.models.notifications.Notifications;
import app.laundrydelegate.viewModels.NotificationsItemViewModels;
...
public class NotificationsAdapter extends RecyclerView.Adapter<NotificationsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        Notifications details = notifications.get(position);
